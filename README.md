...
- Ensure the `output_images` and `tests/results` directories exist before generating visualizations.
- The `test_runner.py` script supports saving results for visualization purposes with the
  `--save-results` flag.
